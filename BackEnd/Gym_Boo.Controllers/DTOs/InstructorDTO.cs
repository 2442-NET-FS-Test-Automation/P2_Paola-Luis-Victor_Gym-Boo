...
public record SubscriberDto(int Id, string Email, bool IsPresent);
...
public record UpcomingSessionDto(int SessionId, string ClassName, string PlaceName, DateTime StartTime, DateTime EndTime, int AvailableSlots );
