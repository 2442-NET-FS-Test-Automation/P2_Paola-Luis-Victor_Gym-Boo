...
public class ReservationService : IReservationService
{
    ...
    public async Task<UserReservationsResponseDto> GetUserReservationHistoryAsync(int userId)
    {
        ...
        var mappedItems = enrollments.Select(e => new ReservationItemDto(
            ...
            StartTime: DateTime.SpecifyKind(e.Session?.Start ?? DateTime.MinValue, DateTimeKind.Utc),
            EndTime: DateTime.SpecifyKind(e.Session?.End ?? DateTime.MinValue, DateTimeKind.Utc),
